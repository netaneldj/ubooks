            ...
            <div class="row">
                    ...
                    <div class="span12">
                            ...
                            <div class="error-container">
                                    ...
                                    <h2>Oh rayos! esto es vergonzoso.. El ID seleccionado no existe en el sistema, por favor elige otro!</h2>

                                    <div class="error-details">
                                            Disculpe las molestias, ocurrio un error! intenta elegir otro ID!
