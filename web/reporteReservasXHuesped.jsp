...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Reservas por Huesped - Reservas Hotel</title>
                                    ...
                                    <tr>
                                        <%
                                            ...
                                            for (Reserva reserva : reservas) {
                                                if (reserva.getHuesped().getId() == Integer.parseInt(request.getParameter("id_huesped")) &&
                                                        controladoraLogica.convertirStringADate(request.getParameter("fecha_desde")).compareTo(reserva.getCheckIn())*reserva.getCheckIn().compareTo(controladoraLogica.convertirStringADate(request.getParameter("fecha_hasta")))>=0) {
                                        %>
