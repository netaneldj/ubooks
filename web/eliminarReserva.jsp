...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Eliminar Reserva - Reservas Hotel</title>
                ...
                <div class="span5 ">
                    <div class="account-container register ">
                        <div class="content clearfix widget">
                            <form action="SvBorrarReserva" method="POST">
                                <h1>Eliminar Reserva</h1>			
                                <div class="login-fields">
                                    <p>Recorda que se borrara la reserva!</p>
                                    <p>Reserva: <select name="id"> </p>
                                    <%      
                                        ControladoraLogica controladoraLogica = new ControladoraLogica();
                                        List<Reserva> reservas = controladoraLogica.obtenerReservas();
                                                for (Reserva reserva : reservas) {
                                    %>
                                    <option value=<%=reserva.getId()%>><%=reserva.getHuesped().getNombre()+" "+reserva.getHuesped().getApellido()+" "+controladoraLogica.convertirDateAString(reserva.getCheckIn())+"-"+controladoraLogica.convertirDateAString(reserva.getCheckOut())%></option>
                                    <% }%>
                                    </select> <!-- /field -->
