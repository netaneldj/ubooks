<%-- 
    ...
    Created on : 23 nov 2024, 18:37:44
    Author     : vzaca
--%>
                                    ...
                                    <tr>
                                        <%
                                            ...
                                            String nombreGrupo = "";
                                                ...
                                                for(Cookie cookie : cookies){
                                                        if(cookie.getName().equals("nombre_grupo") ){ 
                                                            nombreGrupo = cookie.getValue();
                                                        }
                                                    }

                                                List<Grupo> grupos = controladoraLogica.obtenerGruposPorNombre(nombreGrupo);
