...
<html lang="es">
    ...
    <body>
        ...
        Lector miembro = controladoraLogica.obtenerLectorPorIdUsuario(Integer.valueOf(id_usuario));
        List<Grupo> misGrupos = controladoraLogica.obtenerGruposPorIdLector(miembro.getId());
