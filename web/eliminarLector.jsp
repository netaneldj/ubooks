...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Eliminar Lector - Ubooks</title>
                ...
                <div class="span5">
                    <div class="account-container register ">
                        <div class="content clearfix widget">
                            <form action="SvBorrarLector" method="POST">
                                <h1>Eliminar Lector</h1>			
                                <div class="login-fields">
                                    <p>Recorda que se borrara al lector y su usuario!</p>
                                    <p>Lector: <select name="id"> </p>
                                    <%
