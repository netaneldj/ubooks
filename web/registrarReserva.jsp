...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Registrar Reserva - Reservas Hotel</title>
	...
	<div class="content clearfix">
            ...
            <form action="SvAgregarReserva" method="POST" id="1">
			...
			<div class="login-fields">
				...
				<p>Habitación: <select name="id_habitacion"> </p>
					...
					<input type="date" form="1" name="checkin" min="2000-01-01" max="2099-12-31" value="" placeholder="" class="login" />
				</div> <!-- /field -->
                                
                                <div class="field">
					<label for="checkout">Fecha de check-out:</label>	
					<input type="date" form="1" name="checkout" min="2000-01-01" max="2099-12-31" value="" placeholder="" class="login" />
				</div> <!-- /field -->
                                
                                <div class="field">
					<label for="nro_huespedes">Cantidad huespedes:</label>	
					<input type="number" id="nro_huespedes" name="nro_huespedes" value="" placeholder="Cantidad huespedes:" class="login" />
				</div> <!-- /field -->
