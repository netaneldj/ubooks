...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Registrar Habitacion - Reservas Hotel</title>
		...
		<form action="SvAgregarHabitacion" method="POST">
			...
			<div class="login-fields">
				...
				<p>Tematica: <select name="tematica"> </p>
					...
					<input type="number" id="piso" name="piso" value="" placeholder="Piso" class="login" />
				</div> <!-- /field -->
                                
                                <div class="field">
					<label for="precio">Precio:</label>	
					<input type="number" step="0.01" id="precio" name="precio" value="" placeholder="Precio" class="login" />
				</div> <!-- /field -->
			</div> <!-- /login-fields -->
