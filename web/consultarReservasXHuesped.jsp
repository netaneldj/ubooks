                ...
                <div class="span6">
                    <div class="account-container register ">
                        <div class="content clearfix widget">
                            <form action="reporteReservasXHuesped.jsp" method="POST" id="1">
                                <h1>Seleccionar Huesped</h1>			
					...
					<input type="date" form="1" name="fecha_desde" min="2000-01-01" max="2099-12-31" value="" placeholder="" class="login" />
				</div> <!-- /field -->
                                
                                <div class="field">
					<label for="fecha_hasta">Fecha hasta:</label>	
					<input type="date" form="1" name="fecha_hasta" min="2000-01-01" max="2099-12-31" value="" placeholder="" class="login" />
				</div> <!-- /field -->
                                </div> <!-- /login-fields -->
