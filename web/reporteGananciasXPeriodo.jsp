                                    ...
                                    <tr>
                                        <%
                                            ...
                                            for (Reserva reserva : reservas) {
                                                if (controladoraLogica.convertirStringADate(request.getParameter("fecha_desde")).compareTo(reserva.getCheckOut())*reserva.getCheckOut().compareTo(controladoraLogica.convertirStringADate(request.getParameter("fecha_hasta")))>=0) {
