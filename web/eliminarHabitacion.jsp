...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Eliminar Habitación - Reservas Hotel</title>
                ...
                <div class="span5 ">
                    <div class="account-container register ">
                        <div class="content clearfix widget">
                            <form action="SvBorrarHabitacion" method="POST">
                                <h1>Eliminar Habitación</h1>			
                                <div class="login-fields">
                                    <p>Recorda que se borrara la habitación!</p>
                                    <p>Habitación: <select name="id"> </p>
                                    <%
