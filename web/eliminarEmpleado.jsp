...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Eliminar Empleado - Reservas Hotel</title>
                ...
                <div class="span5">
                    <div class="account-container register ">
                        <div class="content clearfix widget">
                            <form action="SvBorrarEmpleado" method="POST">
                                <h1>Eliminar Empleado</h1>			
                                <div class="login-fields">
                                    <p>Recorda que se borrara al empleado y su usuario!</p>
                                    <p>Empleado: <select name="id"> </p>
                                    <%
