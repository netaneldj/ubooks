...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Reservas por Día - Reservas Hotel</title>
                                    ...
                                    <tr>
                                        <%
                                            ...
                                            for (Reserva reserva : reservas) {
                                                if (reserva.getCheckIn().compareTo(controladoraLogica.convertirStringADate(request.getParameter("fecha")))*controladoraLogica.convertirStringADate(request.getParameter("fecha")).compareTo(reserva.getCheckOut())>=0) {
                                        %>
