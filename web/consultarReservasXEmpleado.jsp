...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Reservas por Empleado - Reservas Hotel</title>
                ...
                <div class="span6">
                    <div class="account-container register ">
                        <div class="content clearfix widget">
                            <form action="reporteReservasXEmpleado.jsp" method="POST">
                                <h1>Seleccionar Empleado</h1>			
                                <div class="login-fields">                                    
                                    <%
                                            ControladoraLogica controladoraLogica = new ControladoraLogica();
                                    %>
                                    <p>Empleado: <select name="id_empleado"> </p>
                                    <%
